...
const DeliveryDetails: React.FC = () => {
  ...
  const fetchAddresses = async () => {
    try {
      ...
      const defaultAddresses = response.data.filter((addr: Address) => addr.is_default);
      ...
      <>
        <div className="group bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 border border-gray-100 hover:border-blue-200 transform hover:-translate-y-1">
          <div className="text-center">
            ...
            <p className="text-xl font-bold text-gray-900 mb-2">No default delivery address found</p>
            <p className="text-gray-500 mb-4">Please set a default delivery address to continue with your order.</p>
            <button
              onClick={handleEdit}
