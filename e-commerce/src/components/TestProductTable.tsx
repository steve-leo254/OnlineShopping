...
const CategoryForm: React.FC<CategoryFormProps> = ({ onClose, onCategoryAdded }) => {
  ...
  return (
    <section className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 sm:p-8 rounded-lg shadow-2xl antialiased relative overflow-hidden">
      ...
      <div className="absolute -top-10 -left-10 w-48 h-48 bg-blue-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse"></div>
      <div className="absolute -bottom-10 -right-10 w-48 h-48 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse"></div>
